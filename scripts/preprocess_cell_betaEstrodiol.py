...
list_in = []
list_out = []
for file_cell in Path("./data/raw/EYrainbowWhi5Up_betaEstrodiol").glob("camera*.nd2"):
    list_in.append(file_cell)
    file_segm = Path("./data/cell/EYrainbowWhi5Up_betaEstrodiol_yeaz")/f"binCell-{file_cell.stem.partition('-')[2]}.tif"
